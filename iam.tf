...
resource "aws_iam_role_policy_attachment" "static-site-deployer" {
  role       = aws_iam_role.static-site-deployer.id
  policy_arn = aws_iam_policy.static-site-deployer.arn
}
